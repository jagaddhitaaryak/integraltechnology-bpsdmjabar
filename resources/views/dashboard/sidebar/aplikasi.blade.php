            ...
            <ul class="list-unstyled components list-group" id="list-tab" role="tablist">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li id="list-webinar-list" data-bs-toggle="list" href="#list-webinar" role="tab" aria-controls="list-webinar"><a href="#list-webinar">Webinar</a></li>
                        <li id="list-pelatihan-list" data-bs-toggle="list" href="#list-pelatihan" role="tab" aria-controls="list-pelatihan"><a href="#list-pelatihan">Pelatihan</a></li>
                        <li id="list-sertifikasi-list" data-bs-toggle="list" href="#list-sertifikasi" role="tab" aria-controls="list-sertifikasi"><a href="#list-sertifikasi">Sertifikasi</a></li>
                    </ul>
                </li>
                <li id="list-multimedia-list" data-bs-toggle="list" href="#list-multimedia" role="tab" aria-controls="list-multimedia">
                    <a href="#list-multimedia"><i class="fa-solid fa-camera"></i>Multimedia</a>
                </li>
                <li id="list-publikasi-list" data-bs-toggle="list" href="#list-publikasi" role="tab" aria-controls="list-publikasi">
                    <a href="#list-publikasi"><i class="fa-solid fa-location-arrow"></i>Publikasi</a>
                </li>
            </ul>
        </nav>
        <!-- Tutup sidebar -->
