...
@section('content')
    <!-- List Grup -->
    <section>
        <div class="container mt-3" style="border-radius: 10px; background: #F9A602;">
            <div class="row">
                <div class="col-sm-12 mt-2">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="h2">Tambah Data Pelatihan</h1>
                        </div>
                        <!-- Pelatihan -->
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6 col-sm-12">
                                    <form action="/dashboard/pelatihan" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 mt-3">
                                            <label for="nPelatihan" class="form-label">Nama Kegiatan Pelatihan</label>
                                            <input type="text" class="form-control @error('nPelatihan') is-invalid @enderror" id="nPelatihan" name="nPelatihan" required autofocus value="{{ old('nPelatihan') }}">
                                            @error('nPelatihan')
                                                <div class="invalid-feedback">
                                                {{ $message }}
                                                </div>
